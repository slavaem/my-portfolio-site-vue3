...
@-webkit-keyframes sweep {
  0%    {opacity: 0; -webkit-transform: scale(0.95, 0.95); transform: scale(0.95, 0.95);}
...
<div class="cont3">
<ul class="tab-links">
<li class="card-header1 window-active"><a href="#tab1"></a>Общие</li>
<li class="card-header2"><a href="#tab2"></a>Оплата</li>
<li class="card-header3"><a href="#tab3"></a>Уборка</li>
<li class="card-header4"><a href="#tab4"></a>Работа</li>
</ul>
<div class="card-body tab-content">
<div id="tab1" class="tab window-active">
<details open>
    <summary>Занимаетесь ли вы отдельно мойкой окон?</summary>
    <p>Конечно, мы занимаемся сезонной мойкой окон, а также моем окна после ремонта.</p>
    
    <p>Если заказывать сезонную мойку окон вместе с уборкой квартиры, то стоимость будет 110 грн 1 окно (130 на 140 см). Если заказывать отдельно только мойку окон, без уборки квариры – 160 грн 1 окно (130 на 140 см).</p> 
    
    <p>Если у Вас большие панорамные окна, то клинер на месте визуально определит сколько стандартных окон входит в 1 большое, а менеджер соответственно просчитает стоимость.</p> 
    
    <p>Стоимость мытья окон после ремонта – 130 грн за 1 кв.м. с двух сторон. Минимальная стоимость выезда для мытья окон после ремонта – 1500 грн. </p>
</details>
<details>
    <summary>Что такое уборка по подписке?</summary>
    <p>Подписка – это пакет уборок на месяц, то есть если Вы заказываете минимум 2 уборки на месяц. Такой пакет действует ровно 30 дней с момента первой уборки. Затем на следующий день мы Вам напишем в мессенджере (как правило, это Telegram, Viber) о том, что вы оплатили подписку, укажем до какого числа она действует и уточним, когда Вы планируете следующую/следующие уборки. 
    
    Подписку мы не продлеваем! То есть если Вы купили 1 мая подписку на 3 уборки, и 2 уборки использовали 1 мая и 30 мая, мы не сможем 3 уборку запланировать на последующие дни. Мы сможем сохранить стоимость оплаченной уборки, но Вам нужно будет доплатить разницу, эквивалентную стоимости такой же только разовой уборки. То есть Вы оплатили подписку на 3 базовые уборки для 1-комнатной квартиры = 2100 грн (700 грн каждая уборка) – мы сохраняем стоимость 700 грн + 50 грн доплата (потому что базовая единоразовая уборка стоит 750 грн). </p>

</details>
<details>
    <summary>Вы занимаетесь химчисткой?</summary>
    <p>Во время уборки клинер по умолчанию пылесосит всю мебель. Но если Вам требуется удаление пятен и паровая обработка, то лучше обратиться в специализированные службы.</p>
</details>
</div>
<div id="tab2" class="tab"><details open>
    <summary>Как и когда происходит оплата?</summary>
    <p>Если это разовая уборка или сервис-оплату берем всегда вконце уборки, после того как Вы все проверили. Если есть замечания – готовы на месте все исправить.</p>
    <p>Если это уборка по подписке-работа оплачивается заранее.</p>
</details>
<details>
    <summary>Какие есть способы оплаты?</summary>
    <p>Рассчитаться можно либо наличными с клинером, либо нам на карту приват24. Если оплата на карту – на протяжении уборки менеджер отправит Вам реквизиты. </p>

</details></div>
<div id="tab3" class="tab"><details open>
    <summary>Что мы НЕ делаем?</summary>
    <p>1. Мы не моем люстры! Никогда! Люстры бывают разные: неистово дорогие, с большой кучей маленьких деталей, хрустальные, с большим количеством деталей, часто их нужно снимать, нашим клинерам пока это не под силу, но мы стараемся! Работу делаем или хорошо или никак!</p>
    
    <p>2. Жалюзи. Как показывает практика, что жалюзи недалёко ушли от люстр😂 Ломаются при первом касании, обрываются. Обеспыливание и т. д. не очень вариант, лучшее всего разобрать и помыть под водой. Разбирать – проблема, можем не собрать!</p>
    
    <p>3. Мы не передвигаем тяжело габаритные предметы. Почему? У нас работают хрупкие женщины, они не могут подымать и передвигать тяжести: холодильники, кровати, шкафы, диваны, столы, тумбы, тяжелые цветочные горшки. Помимо травм могут повредить ваш пол.</p>
    
    <p>4. Не вытираем пыль на листьях цветов.</p>
    
    <p>5. Не чистим внутри вытяжку, только фасады.</p>
</details>
</div>
<div id="tab4" class="tab"><details open>
    <summary>Как вы выбираете работников?</summary>
    <p>Это длинная история…сначала проверяем на адекватность по внешним критериям, потом по базам на наличие судимостей, плохих кредитных историй, затем приглашаем на тренинг, показываем, рассказываем, объясняем и сто раз проговариваем о том как говорить с клиентом, как себя вести, чем и где нужно убирать. После тренинга будущие клинеры пишут тест из 100 вопросов по уборке. Если же тест написан хорошо💯, мы проговариваем ошибки ещё раз и отправляем на следующий этап. Затем клинер проходит стажировку со старшим клинером, и если нет замечаний – только тогда приступает к реальным заказам. </p>
</details>
<details>
    <summary>Какие главные требования к работникам?</summary>
    <p>Главное отсутствие вредных привычек, судимостей и желание работать.</p>
