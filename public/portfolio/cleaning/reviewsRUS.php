...
.img-circle {border: .2em solid white;
border-radius: 100%;
width: 20vw;
height: 20vw;
box-shadow: 0 0 7px white;
margin: 0 auto;}
.wriper__reviews__text:before {
content: '';
margin-right: 10px;
}
.reviews__title {
...
@media all and (max-width: 425px) {
 ...
 .wriper__reviews {border-radius: 20vw;}
 }
...
<g>
   ...
   <h1 class="reviews__title">Отзывы наших постоянных клиентов</h1>
    <div class="slider">
     <div class="slider__wrapper">
      <div class="slider__items">
        <div class="slider__item">
          <div style="height: 40vh;">
		  <div class="desctop"><figure class="wriper__reviews">
		  <blockquote>
		  <div class="">
		  <img alt="Фото клиента" class="img-circle" src="http://www.menucool.com/slider/prod/image-slider-1.jpg"></div>
		  <div class="">
		  <p class="wriper__reviews__text">"Все нравится. Отличный сервис."</p>                         
		  <small>Александр Захаров,</small>
		  <p><small>предприниматель.</small></p>
		  </div>
		  </blockquote>
		  </figure>
		  </div>
		  <div class="mobile"><figure class="wriper__reviews"><blockquote>
		  <div class="">
		  <img alt="Фото клиента" class="img-circle" src="http://www.menucool.com/slider/prod/image-slider-1.jpg"></div>
		  <div class="">
		  <p class="wriper__reviews__text">"Все нравится. Отличный сервис."</p>                         
		  <small>Александр Захаров, предприниматель</small>
		  </div>
		  </blockquote></figure>
		  </div>
		  </div>
  ...
  <h1><strong>Оставить отзыв</strong></h1>
  <div class="cont3">
  1. Select Plan
  2. Install Disqus
  Select Platform
  ...
  */
  ...
  s.src = 'https://uberemslavutich.disqus.com/embed.js';
...
<script id="dsq-count-scr" src="//uberemslavutich.disqus.com/count.js" async></script>
</body>
</html>